public class CircularlyArrayList<E> implements List<E> {
    ...
    public CircularlyArrayList() {this(CAPACITY);}

    public CircularlyArrayList(int cap) {
    ...
    public void add(int i, E e) throws IndexOutOfBoundsException {
        checkIndex(i);
        if(size == data.length) {
            throw new IndexOutOfBoundsException("Cannot add any more elements the size limit has been reached");
        }
        if(i == size-1) {
        data[size-1] = e;
        //tail = data[size-1];
